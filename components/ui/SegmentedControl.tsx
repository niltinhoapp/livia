      ...
      {items.map((it) => {
        ...
        return (
          <button
            ...
            className={`min-h-11 flex-1 rounded-sm px-3 py-2 text-sm font-semibold transition-colors duration-150 ${
...
export function Chip({
  ...
  return (
    <button
      ...
      aria-pressed={active}
      onClick={onClick}
      className={`inline-flex min-h-9 items-center gap-1 rounded-full border px-3 py-1.5 text-xs font-semibold transition-colors duration-150 ${
        active
