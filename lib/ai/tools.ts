...
export const TOOL_REGISTRY: ToolDefinition[] = [
  ...
  rescheduleAppointment,
  cancelAppointment,
  listMenuTool, searchMenu, getMenuProductTool, getOrderDraftTool, addOrderItemTool, updateOrderItemTool, removeOrderItemTool, setOrderFulfillmentTool, setOrderAddressTool, setOrderPaymentTool, confirmOrderTool, getOrderStatusTool,
  requestHumanHandoff,
];
