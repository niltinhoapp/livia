...
const RULES: Rule[] = [
  ...
  // ANTES de schedule_appointment de propósito: "tenho consulta hoje?" e
  // "qual horário marquei?" falam de um agendamento que JÁ existe, não de
  // querer marcar um novo. Depois de cancelar/remarcar, que continuam
  // vencendo ("quero remarcar minha consulta" é remarcação, não consulta).
  {
    ...
    keywords: [
      ...
      "qual meu horario",
      "qual meu horário",
      "que horas e meu horario",
      "que horas é meu horário",
      "que horas e minha consulta",
