...
// Espelha a mesma regra aplicada em lib/ai/brain.ts e lib/ai/summarize.ts.
function tokenLimit(model: string, n: number): { max_completion_tokens: number } | { max_tokens: number } {
  return model === "gpt-5.4-mini" ? { max_completion_tokens: n } : { max_tokens: n };
}
...
// ---- Cenário 1: chamada crua, sem tools — isola só model/temperature/limite de tokens ----
